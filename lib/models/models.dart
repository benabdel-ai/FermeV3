...
class Depense {
  ...
  Depense copyWith({double? montant, DateTime? date, String? categorie, String? remarque, String? fermeId}) =>
      Depense(id: id, montant: montant ?? this.montant, date: date ?? this.date, categorie: categorie ?? this.categorie, remarque: remarque ?? this.remarque, fermeId: fermeId ?? this.fermeId);
}
...
class Revenu {
  ...
  Revenu copyWith({double? montant, DateTime? date, String? categorie, String? remarque, String? fermeId}) =>
      Revenu(id: id, montant: montant ?? this.montant, date: date ?? this.date, categorie: categorie ?? this.categorie, remarque: remarque ?? this.remarque, fermeId: fermeId ?? this.fermeId);
}
